...
/* harmony import */ var app_core_data_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! app/core/data.service */ "./src/app/core/data.service.ts");
...
var AddBookComponent = /** @class */ (function () {
    ...
    AddBookComponent.prototype.saveBook = function (formValues) {
        ...
        newBook.bookID = 0;
        console.log(newBook);
        this.dataService.addBook(newBook).subscribe(function (data) { return console.log(data); }, function (err) { return console.log(err); });
    };
    AddBookComponent = __decorate([
        ...
        __metadata("design:paramtypes", [app_core_data_service__WEBPACK_IMPORTED_MODULE_0__["DataService"]])
    ], AddBookComponent);
...
var AddReaderComponent = /** @class */ (function () {
    ...
    AddReaderComponent.prototype.saveReader = function (formValues) {
        ...
        this.dataService.addReader(newReader).subscribe(function (data) { return console.log(data); }, function (err) { return console.log(err); });
    };
...
var BooksResolverService = /** @class */ (function () {
    ...
    BooksResolverService.prototype.resolve = function (route, state) {
        return this.dataService.getAllBooks().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(err); }));
    };
...
/* harmony import */ var _services_http_cache_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../services/http-cache.service */ "./src/app/services/http-cache.service.ts");
...
var CacheInterceptor = /** @class */ (function () {
    ...
    CacheInterceptor = __decorate([
        ...
        __metadata("design:paramtypes", [_services_http_cache_service__WEBPACK_IMPORTED_MODULE_0__["HttpCacheService"]])
    ], CacheInterceptor);
...
/* harmony import */ var _add_header_interceptor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-header.interceptor */ "./src/app/core/add-header.interceptor.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
    ...
    CoreModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _add_header_interceptor__WEBPACK_IMPORTED_MODULE_0__["AddHeaderInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _log_response_interceptor__WEBPACK_IMPORTED_MODULE_8__["LogResponseInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: _cache_interceptor__WEBPACK_IMPORTED_MODULE_9__["CacheInterceptor"], multi: true }
            ]
        }),
...
/* harmony import */ var app_models_bookTrackerError__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! app/models/bookTrackerError */ "./src/app/models/bookTrackerError.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getAllBooks = function () {
        var _this = this;
        return this.http.get('/api/books').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) { return _this.handleHttpError(err); }));
    };
    DataService.prototype.handleHttpError = function (error) {
        var dataError = new app_models_bookTrackerError__WEBPACK_IMPORTED_MODULE_0__["BookTrackerError"]();
    ...
    DataService.prototype.getOldBookById = function (id) {
        return this.http.get("/api/books/" + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (b) { return ({
            booktitle: b.title,
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        var resolvedData = this.router.snapshot.data['resolvedBooks'];
        if (resolvedData instanceof app_models_bookTrackerError__WEBPACK_IMPORTED_MODULE_0__["BookTrackerError"]) {
            console.log("Dashboard component error: " + resolvedData.friendlyMessage + " ");
        }
        else {
            this.allBooks = resolvedData;
        }
        this.dataService.getAllReaders().subscribe(function (data) { return _this.allReaders = data; });
...
var EditBookComponent = /** @class */ (function () {
    ...
    EditBookComponent.prototype.saveChanges = function () {
        this.dataService.updateBook(this.selectedBook).subscribe(function (data) { return console.log('update successfully'); }, function (err) { return console.log(err); });
    };
...
var EditReaderComponent = /** @class */ (function () {
    ...
    EditReaderComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getReaderById(readerID).subscribe(function (data) { return _this.selectedReader = data; });
        this.currentBadge = this.badgeService.getReaderBadge(this.selectedReader.totalMinutesRead);
    };
    EditReaderComponent.prototype.saveChanges = function () {
        this.dataService.updateReader(this.selectedReader).subscribe(function (data) { return console.log('update successfully'); }, function (err) { return console.log(err); });
    };
...
module.exports = __webpack_require__(/*! D:\Cursos\Pluralsight\Angular\Angular HTTP communication\BookTracker\Angular-Http-Communication\src\main.ts */"./src/main.ts");
